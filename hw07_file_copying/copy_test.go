...
func TestCopy(t *testing.T) {
	t.Run("simple copy", func(t *testing.T) {
		Copy("testdata/input.txt", "testdata/output.txt", 0, 0, false)
	...
	t.Run("limit and offset", func(t *testing.T) {
		limit := 1000
		Copy("testdata/input.txt", "testdata/output.txt", 100, limit, false)
		defer os.Remove("testdata/output.txt")
		out, err := readFile("testdata/output.txt")
		if err != nil {
			t.Error(err)
	...
	t.Run("test big offset", func(t *testing.T) {
		offset := 6000
		Copy("testdata/input.txt", "testdata/output.txt", offset, 1000, false)
		defer os.Remove("testdata/output.txt")
		in, err := readFile("testdata/input.txt")
		if err != nil {
			t.Error(err)
